...
export function BarChart(){
    ...
    const Chart = () => {
        ...
        return (
            <article className="h-270px w-450px ml-2em por">
                <span className="poa rot--90 t-115px l--18em lsp-05em">Confidence</span>
                <span className="poa b-0 l-50pc lsp-05em">Tools</span>
    ...
    const Info = ({iconName}) => {
        ...
        return (
            <ul className="ml-2em">
                <li className="flex ali-c">
                    <Icon className="fs-25em mr-03em"/>{iconName}
                </li>
